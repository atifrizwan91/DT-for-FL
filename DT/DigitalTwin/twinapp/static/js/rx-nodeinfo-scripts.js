...
<div class="row">\
    <div class="col-sm-12">\
        <div class="card shadow mb-1">\
            ...
            <h6 class="m-0 font-weight-bold text-primary ">${nodeInfo.name}</h6>\
            </div>\
            <img src="/static/img/01.edgenode.png" width="73" height="70">\
            <div class="card-body text-primary">\
                Node Images: ${respinfo.images}<hr>\
                RunningContainers:${respinfo.runningContainers}<hr>\
                OperatirngSystem: ${respinfo.operatirngSystem}<hr>\
...
statisticsInfo.forEach(statistic => {
    ...
    var labelx = "number of experiments";
    var label1 = statistic.datasets[0].label;
    
    if (label1 === "temperature"){
    ...
    var ctx = $(`#barDataChart-${statistic.device}`);
    var myLineChart = new Chart(ctx, {
        ...
        options: {
            title: {
                display: true,
                text: 'Results of '+statistic.device
            },
