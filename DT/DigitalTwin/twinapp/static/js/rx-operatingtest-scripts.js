    ...
    $.ajax({
        ...
        if (data) {
            for( n in data){
                ...
                if(data[n].status){
                    $('#tsmapid-' + data[n].id).text('Operating');
                    $('#tsmapid-' + data[n].id).addClass('btn-danger');
                    $('#spinner-tsmapid-' + data[n].id).show();
                }else{
                    $('#tsmapid-' + data[n].id).text('Operate');
                    $('#tsmapid-' + data[n].id).removeClass('btn-danger');
                    $('#spinner-tsmapid-' + data[n].id).hide();
                }
